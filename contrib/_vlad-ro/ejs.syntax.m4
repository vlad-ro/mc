...
context <% %>                   EJS_DEFAULT
    ...
    keyword whole case EJS_KEYWORD
    keyword whole catch EJS_KEYWORD
    keyword whole class EJS_KEYWORD
    keyword whole const EJS_KEYWORD
    keyword whole constructor EJS_KEYWORD
    keyword whole continue EJS_KEYWORD
    keyword whole else EJS_KEYWORD
    keyword whole extends EJS_KEYWORD
    keyword whole export EJS_KEYWORD
    keyword whole default EJS_KEYWORD
    keyword whole delete EJS_KEYWORD
    keyword whole for EJS_KEYWORD
    keyword whole function EJS_KEYWORD
    keyword whole if EJS_KEYWORD
    keyword whole import EJS_KEYWORD
    keyword whole in EJS_KEYWORD
    keyword whole instanceof EJS_KEYWORD
    keyword whole let EJS_KEYWORD
    keyword whole new EJS_KEYWORD
    keyword whole of EJS_KEYWORD
    keyword whole prototype EJS_KEYWORD
    keyword whole return EJS_KEYWORD
    keyword whole switch EJS_KEYWORD
    keyword whole this EJS_KEYWORD
    keyword whole throw EJS_KEYWORD
    keyword whole try EJS_KEYWORD
    keyword whole typeof EJS_KEYWORD
    keyword whole var EJS_KEYWORD
    keyword whole while EJS_KEYWORD
    keyword whole with EJS_KEYWORD
    keyword whole yield EJS_KEYWORD

    #=========================
    # Objects
    keyword whole ActiveXObject EJS_KEYWORD
    keyword whole Array EJS_KEYWORD
    keyword whole Boolean EJS_KEYWORD
    keyword whole Date EJS_KEYWORD
    keyword whole Dictionary EJS_KEYWORD
    keyword whole Enumerator EJS_KEYWORD
    keyword whole FileSystemObject EJS_KEYWORD
    keyword whole Function EJS_KEYWORD
    keyword whole Global EJS_KEYWORD
    keyword whole Image EJS_KEYWORD
    keyword whole Math EJS_KEYWORD
    keyword whole Map EJS_KEYWORD
    keyword whole Number EJS_KEYWORD
    keyword whole Object EJS_KEYWORD
    keyword whole Promise EJS_KEYWORD
    keyword whole Proxy EJS_KEYWORD
    keyword whole Reflect EJS_KEYWORD
    keyword whole Set EJS_KEYWORD
    keyword whole Symbol EJS_KEYWORD
    keyword whole TextStream EJS_KEYWORD
    keyword whole RegExp EJS_KEYWORD
    keyword whole VBArray EJS_KEYWORD
    keyword whole WeakMap EJS_KEYWORD
    keyword whole WeakSet EJS_KEYWORD

    #=========================
    # Most common functions
    keyword whole alert EJS_KEYWORD
    keyword whole escape EJS_KEYWORD
    keyword whole eval EJS_KEYWORD
    keyword whole indexOf EJS_KEYWORD
    keyword whole isNaN EJS_KEYWORD
    keyword whole toString EJS_KEYWORD
    keyword whole unescape EJS_KEYWORD
    keyword whole valueOf EJS_KEYWORD
    ...
    keyword whole undefined EJS_KEYWORD
